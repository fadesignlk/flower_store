...
<body>
    ...
    <section class="add-products">
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <input type="text" class="box" name="name" required placeholder="Enter Product Name">
            <input type="number" min="0" class="box" name="price" required placeholder="Enter Product Price">
